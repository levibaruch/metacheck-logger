...
- 🔍 [Repository Check](#repository-check){.yellow}: 
    -  We found 7 files in 3 repositories.
...
2L, 1L), "Data Files" = c(1L, 1L, 0L), "Code Files" = c(2L, 1L, 
...
"183 B"), Type = c("code", "data", "code", "archive", "code", 
"data", "code")), row.names = c(NA, 7L), class = "data.frame")
