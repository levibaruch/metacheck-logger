...
- [Reference Check](#reference-check){.yellow}: We checked 4 references in CrossRef, 3 of which had a DOI. We found 1 missing DOI and 0 DOIs that did not match the original. We could not find matches for 0 references.  
...
### Reference Check {.yellow}

We checked 4 references in CrossRef, 3 of which had a DOI. We found 1 missing DOI and 0 DOIs that did not match the original. We could not find matches for 0 references.

Double check any references listed in the tables below. Many books do not have a DOI or are not listed in CrossRef. Garbled references are usually a result of poor parsing of the paper by grobid; we are working on more accurate alternatives.
...
table <- structure(list("Found DOI" = "<a href='https://doi.org/10.1177/2515245918770963' target='_blank'>doi.org/10.1177/2515245918770963</a>", 
    "Original Reference" = "Lakens D (2018). &ldquo;Equivalence testing for psychological research.&rdquo; <em>Advances in Methods and Practices in Psychological Science</em>, <b>1</b>, 259-270."), row.names = 4L, class = "data.frame")
...
::: {.callout-tip title="Experimental Checks" collapse="true"}
