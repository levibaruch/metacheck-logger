[MetaCheck](http://www.scienceverse.org/metacheck) version 0.0.0.9066  
...
- ⚠️ [COI Check](#coi-check): No conflict of interest statement was
  detected.  
- 🔍 [Power Analysis Check](#power-analysis-check): We detected 1
...
You chose to not use an LLM to assess if all information was reported,
so please check for all required information manually.
