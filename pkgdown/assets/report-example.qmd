...
function openTab(evt, tabName) {
  ...
  tabcontent = document.getElementsByClassName("level2");
...
# table data --------------------------------------
table <- structure(list("Code File name" = c("bad.R", "bad.Rmd", "analysis.R", 
"Code/Study 1.r"), Language = c("R", "R", "R", "R"), "Percentage of lines that are comments" = c(0.0526315789473684, 
0.0222222222222222, 0, 0.111111111111111)), row.names = c(NA, 
4L), class = "data.frame")
